...
class HabitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create habit" do
    assert_difference('Habit.count') do
      post habits_url, params: { habit: { bad_days: @habit.bad_days, good_days: @habit.good_days, habit: @habit.habit } }
    end
  ...
  test "should update habit" do
    patch habit_url(@habit), params: { habit: { bad_days: @habit.bad_days, good_days: @habit.good_days, habit: @habit.habit } }
